	...
	<main>
        ...
        <?php
            if (isset($_GET['vocab_id'])) {
                $vocab_id = $_GET['vocab_id'];
                $vocab = getVocabById($vocab_id, $user_id);
                ...
                if ($vocab) {
                    ...
                    // Không tìm thấy từ vựng cần chỉnh sửa
                    // Xử lý hoặc hiển thị thông báo lỗi tại đây
                }
            } else {
                // Tham số vocab_id không tồn tại
                // Xử lý hoặc hiển thị thông báo lỗi tại đây
            }
        ?>
        ...
        <form method="post" action="update_word.php">
            ...
            <div class="form-container">
                <div class="form-row">
                    <label for="word">Vocabulary:</label>
                    <input type="text" name="word" id="word" autocomplete="off" required value="<?php echo $word; ?>">
                </div>

                <div class="form-row">
                    <label for="meaning">Meaning:</label>
                    <input type="text" name="meaning" id="meaning" autocomplete="off" required value="<?php echo $meaning; ?>">
                </div>

                <div class="form-row">
                    <label for="pronunciation">Pronunciation:</label>
                    <input type="text" name="pronunciation" id="pronunciation" autocomplete="off" value="<?php echo $pronunciation; ?>">
                </div>

                <div class="form-row">
                    <label for="example">Example:</label>
                    <input type="text" name="example" id="example" autocomplete="off" value="<?php echo $example; ?>">
                </div>

                <div class="form-row">
                    <label for="phrase">Phrase:</label>
                    <input type="text" name="phrase" id="phrase" autocomplete="off" value="<?php echo $phrase; ?>">
                </div>

                <div class="form-row">
                    <label for="note">Note:</label>
                    <input type="text" name="note" id="note" autocomplete="off" value="<?php echo $note; ?>">
                </div>
            </div>

            <input type="hidden" name="vocab_id" value="<?php echo $vocab_id; ?>">
	    ...
	    <?php
	    	...
	    	if (mysqli_num_rows($result) > 0) {
		        ...
		        echo "<table>";
		        echo "<tr><th class='width_ten'>Vocabulary</th><th class='width_ten'>Meaning</th><th class='width_ten'>Pronunciation</th><th>Example</th><th>Phrase</th><th class='width_small'>Date</th></tr>";
